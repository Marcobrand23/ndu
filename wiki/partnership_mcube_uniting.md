...
## Stato: Intro organizzata — meeting in agenda

| Campo | Valore |
|-------|--------|
| Intermediario | Alessandro Zanotti (alessandrozanotti1972@gmail.com) |
| Contatto MCube | Leonardo Comelli (l.comelli@mcubedigital.com) |
| Contatto Uniting | Alessandro Talenti (alessandro.talenti@uniting.it) |
| Referente ND | Marco Brandstetter |
| Intro email | 11/05/2026 |

---

## Slot proposti da Marco per meeting introduttivo

- Mercoledì 13 Maggio 2026 — mattino
- Martedì 19 Maggio 2026 — pomeriggio

---

## Contesto

Alessandro Zanotti ha creato il thread di intro tra:
- **Next Different** (Marco Brandstetter — Data & Retail MD)
- **MCube Digital** (Leonardo Comelli)
- **Uniting** (Alessandro Talenti)

Obiettivo: introduzione tra le organizzazioni + possibili deal insieme.
Zanotti ha confermato che le parti si erano già contattate in precedenza.
