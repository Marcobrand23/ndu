...
## Stato: Proposta in preparazione — PPT valorizzazione traffico inviata

| Campo | Valore |
|-------|--------|
| Cliente finale | Alma Farmacie |
| Intermediario | Pharma-Green (laura@pharma-green.it, marta@pharma-green.it) |
| Progetto | Schermi digitali DOOH nelle farmacie |
| Account NDU | Marco Cagnazzi |
| Destinazione proposta | Sky Media (tramite Pharma-Green) |
...
| Persona | Affiliazione | Email |
|---------|--------------|-------|
| Laura De Stradis | Pharma-Green | laura@pharma-green.it |
| Marta Bezzoli | Pharma-Green | marta@pharma-green.it |
| Marco Cagnazzi | NDU | marco.cagnazzi@nextdifferent.com |
| Marco Brandstetter | NDU | marco.brandstetter@nextdifferent.com |

---

## Stato attuale (14/05/2026)

Marco Cagnazzi ha inviato a Pharma-Green una PPT con:
- Stima del traffico nelle farmacie Alma
- Vari criteri di valorizzazione
- Quantificazione del traffico nelle prime slide (da usare con Sky Media)

Il documento serve a Pharma-Green per presentare a **Sky Media** il valore degli schermi.
...
**Marta Bezzoli invia status farmacie** (mappatura aggiornata):
- **21 farmacie** totali
- **39 schermi** di cui: **23 esterni** + **16 interni**

**Richiesta PPT**:
Marta ha ricevuto la presentazione in PDF — chiede il formato PowerPoint.
> "Ci manderesti la presentazione short in power point? L'abbiamo ricevuta ancora in pdf."
