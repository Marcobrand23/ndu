...
> Dati al 01/04/2026. Fonte: CRM Monday board `2126709061`.
> Per dati aggiornati: usare MCP Monday `get_board_items_nextdifferent` con board ID `2126709061`.

---

## Offerte ad Alta Priorità (chiusura Q2 2026)

| Cliente | Progetto | Revenue | GM | Prob | Prossimo Step | Deadline |
|---------|----------|---------|-----|------|---------------|----------|
| **STAR/ReStore** | Sampling profilato (via Uniting) | 18.800 | 1.980 | 80% | Negoziazione finale | Apr 2026 |
| **Q-Farma/Consulcesi** | Schermi per farmacie | 40.000 | 20.000 | 50% | Meeting post-Pasqua | Apr 2026 |

---

## Clienti con Trattativa in Corso (al 01/04/2026)

Henkel, Trenord, Q-Farma, Moby, Mediolanum, Unieuro, Parmalat, Kia, Euronics, Brico IO, Conad, Barilla, Mulino Bianco, STAR, H&B, Fileni, Iliad

---

## Trattative di Rilievo
